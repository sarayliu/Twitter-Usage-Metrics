...
class TJTwitter 
{
  ...
  /******************  Part 3 *******************/
   public void investigate ()
   {
      ...
      countTweetsFromZipCode("flu", 38.923848, -77.396501, 5);  
      birthdayGreeting("Ling_Wang_1", "Happy Birthday", 10);
      searchForTweets();
      tjMentionedInBio(38.81709, -77.167564, 10, Query.MILES);
   } // :)
   ...
   {
      System.out.println("\n>>>>>Checking tweets regarding flu originating from my zip code, 20171<<<<<");
      ...
      System.out.println("\nThe # of tweets for \"flu\" originated from my zip code (20171) is: " + i + "\n");
   }
   ...
   private void searchForTweets()
   {
      ...
      query.setCount(100);
      query.setGeoCode(new GeoLocation(38.672839,-77.1671443), 10, Query.MILES);
